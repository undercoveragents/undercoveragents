---
name: playground-and-agent-testing
description: Use this skill when explaining how admins can test agents safely, compare behavior, and review transcripts before wider rollout.
---

# Playground and Agent Testing

Use this skill for questions about trying agents in a safe workspace before exposing them more broadly.
...
- The selected agent defines the conversation behavior for that playground session.
- Transcript history and tool activity help explain why an answer looked the way it did.
- The playground is for experimentation, comparison, and prompt iteration rather than production support traffic.
